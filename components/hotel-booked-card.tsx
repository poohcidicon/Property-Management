  ...
  return (
    <div className="max-w-sm mx-auto w-80 bg-white rounded-lg shadow-lg">
      ...
      <div className="px-6 py-4 overflow-y-scroll max-h-[70vh]">
        <div className="flex justify-between items-start mb-4">
          ...
          <div className="flex items-start">
            ...
            <div>
              <p className="text-xs text-gray-500">{locale?.room_dialog?.room_price || 'ราคาห้องพัก'}</p>
        ...
        <div className="border-t border-gray-200 pt-4">
          <SpinnerSmall loading={loading}>
            <div className="text-base font-bold text-gray-800 mb-3 flex justify-between align-center">
              <div>{locale?.room_dialog?.customer_info || 'ข้อมูลผู้จอง'}</div>
            </div>
        ...
        <div className="border-t border-gray-200 pt-4">
          <div className="text-base font-bold text-gray-800 mb-3 flex justify-between align-center">
            <div>{locale?.room_dialog?.lodger_info || 'ข้อมูลผู้เข้าพัก'}</div>
            ...
            return (
              <div className='flex justify-between gap-5 mb-4' key={otherGuest.GuestID}>
                ...
                <div className="flex justify-end items-start">
                  ...
                  >
                    <Trash className='text-white' size={12}/>
                  </button>
                </div>
              </div>
            )
          ...
          <div className="flex justify-between pt-2 border-t border-gray-200">
            <span className="text-gray-800 font-semibold">{locale?.room_dialog?.booking_total_price || 'ค่าจองทั้งหมด'}:</span>
      ...
      <div className="px-6 pb-6">
        ...
        >
          {locale?.room_dialog?.check_in || 'เช็คอิน'}
        </button>
      </div>
        ...
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle className="text-xl font-bold flex items-center gap-2">
              {locale?.room_dialog?.confirm_check_in || 'ยืนยันการเช็คอิน'}
            </DialogTitle>
          </DialogHeader>
